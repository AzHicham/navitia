...
class TestDepartureBoard(AbstractTestFixture):
    ...
    def test_datetime_error(self):
        ...
        def sched(dt):
            return self.query_region(f"stop_points/stop1/stop_schedules?from_datetime={dt}", check=False)
    ...
    def test_datetime_withtz(self):
        ...
        def sched(dt):
            return self.query_region(f"stop_points/stop1/stop_schedules?from_datetime={dt}")
